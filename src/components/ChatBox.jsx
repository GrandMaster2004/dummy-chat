...
const ChatBox = () => {
    ...
    return (
        <div className="flex-1 bg-neutral-900 shadow-lg rounded-xl flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-4 max-h-[65vh]" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }} >
                {messages.map((message, index) => (
                    <div
                        key={index}
                        className={`flex ${message.sender === "receiver"
                    ...
                    >
                        ...
                        <div
                            className={`${message.sender === "sender"
